...
void cvs::daltonlens::SimulateBrettel1997(Deficiency deficiency, float severity,
                                          const BGRA *src, BGRA *dst,
                                          size_t len) {
...
void cvs::daltonlens::SimulateVienot1999(Deficiency deficiency, float severity,
                                         const BGRA *src, BGRA *dst,
                                         size_t len) {
